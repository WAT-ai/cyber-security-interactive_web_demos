    ...
    return (  
        ...
        <div className='dbscan' style={{
            ...
            <div className="next-button">
                <Link to="negative-selection" smooth={true} duration={500} className='next-button-link'>TO NEXT MODEL </Link>
            </div>
